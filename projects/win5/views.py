...
def index(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            # レース場の情報
            location_01 = form.cleaned_data['location_01']
            location_02 = form.cleaned_data['location_02']
            location_03 = form.cleaned_data['location_03']
            location_04 = form.cleaned_data['location_04']
            location_05 = form.cleaned_data['location_05']

            race_number_01 = form.cleaned_data['race_number_01']
            race_number_02 = form.cleaned_data['race_number_02']
            race_number_03 = form.cleaned_data['race_number_03']
            race_number_04 = form.cleaned_data['race_number_04']
            race_number_05 = form.cleaned_data['race_number_05']
            ...
            race_01 = races_info[
                ...
                (races_info['round'] == race_number_01) & 
                (races_info['location'].str.contains(location_01))
            ]
            race_02 = races_info[
                (races_info['date'] == date) & 
                (races_info['round'] == race_number_02) & 
                (races_info['location'].str.contains(location_02))
            ]
            race_03 = races_info[
                (races_info['date'] == date) & 
                (races_info['round'] == race_number_03) & 
                (races_info['location'].str.contains(location_03))
            ]
            race_04 = races_info[
                (races_info['date'] == date) & 
                (races_info['round'] == race_number_04) & 
                (races_info['location'].str.contains(location_04))
            ]
            race_05 = races_info[
                (races_info['date'] == date) & 
                (races_info['round'] == race_number_05) & 
                (races_info['location'].str.contains(location_05))
            ]
            try:
                client = OpenAI(
                    ...
                    messages=[
                        {
                            ...
                            "content": f"""
                            対象日: [{date}]
                            JRAのWIN5の予想をする分析・解析を専門とするプロフェッショナルが役割です。
                            WIN5の予想結果5パターンを返してください。
                            {race_01}から一位の予想してください。馬番号と馬名を教えてください
                            {race_02}から一位の予想してください。馬番号と馬名を教えてください
                            {race_03}から一位の予想してください。馬番号と馬名を教えてください
                            {race_04}から一位の予想してください。馬番号と馬名を教えてください
                            {race_05}から一位の予想してください。馬番号と馬名を教えてください
                            
                            表示結果レイアウト
                            ーーーーーーーーーーーーーーーーーーー
                            WIN5 予想
                            1.[{race_01}の1位予想の馬番号(馬名)] - [{race_02}の1位予想の馬番号(馬名)] - [{race_03}の1位予想の馬番号(馬名)] - [{race_04}の1位予想の馬番号(馬名)] - [{race_05}の1位予想の馬番号(馬名)]
                            2.[{race_01}の1位予想の馬番号(馬名)] - [{race_02}の1位予想の馬番号(馬名)] - [{race_03}の1位予想の馬番号(馬名)] - [{race_04}の1位予想の馬番号(馬名)] - [{race_05}の1位予想の馬番号(馬名)]
                            3.[{race_01}の1位予想の馬番号(馬名)] - [{race_02}の1位予想の馬番号(馬名)] - [{race_03}の1位予想の馬番号(馬名)] - [{race_04}の1位予想の馬番号(馬名)] - [{race_05}の1位予想の馬番号(馬名)]
                            4.[{race_01}の1位予想の馬番号(馬名)] - [{race_02}の1位予想の馬番号(馬名)] - [{race_03}の1位予想の馬番号(馬名)] - [{race_04}の1位予想の馬番号(馬名)] - [{race_05}の1位予想の馬番号(馬名)]
                            5.[{race_01}の1位予想の馬番号(馬名)] - [{race_02}の1位予想の馬番号(馬名)] - [{race_03}の1位予想の馬番号(馬名)] - [{race_04}の1位予想の馬番号(馬名)] - [{race_05}の1位予想の馬番号(馬名)]
                            ーーーーーーーーーーーーーーーーーーー
                            レイアウトに合わせてご回答してください。
                            """
                        }
